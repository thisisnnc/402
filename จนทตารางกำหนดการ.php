...
<div class="fixed-top">
  ...
  <div class="container">
    <div class="d-flex justify-content-center card w-75">
        <div class="card-body">
            <form name="form1" method="post" action="จนทตารางกำหนดการ1.php" enctype="multipart/form-data">
                <div class="mb-3">
                    <label for="formFile" class="form-label">ไฟล์ตารางกำหนดการ</label>
                    <input class="form-control" type="file" id="formFile" name="filUpload">
                  </div>
                  <div class="col-md-12 text-center">
                    <input type="submit" value="บันทึกไฟล์ลงระบบ" class="btn ass_btn  ">
          ...
          <div class="card-body">
            <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    <th scope="row">9</th>
                    <td>ส่งแบบยืนยันค่าจดทะเบียนเรียน,ค่าครองชีพ ทางไปรษณีย์ให้ธนาคารกรุงไทย สานักงานใหญ่</td>
                    <td> 5 ก.ย.2562</td>
                    <td>-</td>
                  </tr>
          ...
          <div class="card-body">
            <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    <th scope="row">3</th>
                    <td>นักศึกษาช้ันปีที่ 1/2562 ภาคปกติที่ประสงค์ใช้สิทธ์ิจดทะเบียนเรียนโดยไม่ต้องสารองเงินจ่ายโปรดส่งใบสมัคร</td>
                    <td>5 – 6 ส.ค. 2562</td>
                  ...
                  <tr>
                    <th scope="row">7</th>
                    <td>บันทึกสัญญา และพิมพ์สัญญาออกจากระบบฯให้ผู้ปกครองลงนามที่อำเภอ/เทศบาล/เขต/ที่มหาวิทยาลัยธรรมศาสตร์</td>
                    <td>7-10 ก.ย.2562</td>
                    <td>-</td>
                  </tr>
                  ...
                  <tr>
                    <th scope="row">10</th>
                    <td>ส่งสัญญาและแบบยืนยันค่าจดทะเบียนเรียน,ค่าครองชีพทางไปรษณีย์ให้ธนาคารกรุงไทย สานักงานใหญ่</td>
                    <td>1 ต.ค. 2562</td>
                    <td>-</td>
                  </tr>
                </tbody>
...
?>
<a href="จนทตารางกำหนดการ1.php">View files</a>
